...
class EstatisticasStructuralTest {
    ...
    void setUp() {
        ...
        usuarioService.limparUsuarios(); // Limpar estado entre testes
    ...
    void getEstatisticasUsuario_MCDC() {
        ...
        assertAll(
                () -> assertTrue(statsUsuarioSemSimulacoes.contains("USER1")), // Maiúsculo na saída
                () -> assertTrue(statsUsuarioSemSimulacoes.contains("Total de simulações: 0")) // String correta
        );
        ...
        assertTrue(statsUsuarioComSimulacoes.contains("Simulações bem-sucedidas: 2"));
    }
